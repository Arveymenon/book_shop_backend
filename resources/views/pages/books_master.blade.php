                                ...
                                <div class="c-modal__body">
                                    <div class="c-select u-mb-xsmall">
                                        <form action='update' method='post' enctype="multipart/form-data">
                                            ...
                                            <div class="c-field">
                                                <label class="c-field__label" for="subject">Subject</label>
                                                <input class="c-input" id="subject" name="subject" type="text" placeholder="Subject">
                                            </div>

                                            <div class="c-field">
                                                <label class="c-field__label" for="authors">Authors</label>
                                                <input class="c-input" id="authors" name="authors" type="text" placeholder="Authors">
                                            </div>

                                            <div class="c-field">
                                                <label class="c-field__label" for="print_date">Print Date</label>
                                                <input class="c-input" id="print_date" name="print_date" type="date" placeholder="Print Date">
                                            </div>

                                            <div class="c-field">
                                                <label class="c-field__label" for="refurbished">Refurbished Available</label>
                                                <input class="c-input" id="refurbished" name="refurbished" type="checkbox">
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#inventory').DataTable( {
                "processing": true,
                "serverSide": true,
                ajax: APP_URL+'/api/books/datatable',
                columns: [
                    { data: 'id', name: 'id'},
                    { data: 'name', name: 'name'},
                    ...
                    { data: 'refurbished_available', name: 'refurbished' , orderable: false},
