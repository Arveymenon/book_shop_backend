            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <script type="text/javascript">
                        function updateStatus(resale_order_id,status) {
                         console.log(resale_order_id);
                         console.log(status);
                            $.ajax({
                                type: "POST",
                                data: {
                                    _token: "{{ csrf_token() }}",
                                    resale_order_id: resale_order_id,
                                    status: status
                                },
                                url: APP_URL + "/resale-order/status/update",
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#inventory').DataTable( {
                "processing": true,
                "serverSide": true,
                ajax: APP_URL+'/api/resale-order/datatable',
                columns: [
                    { data: 'id', name: 'id'},
                    { data: 'order.customer.name', name: 'Customer Name'},
                    { data: 'order.customer.mobile', name: 'Customer Contact'},
                    ...
                    { data: 'transaction_id', name: 'Transaction ID', defaultContent: 'Not Set Yet'},
